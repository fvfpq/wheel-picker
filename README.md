...
- **指定结果**：在后台列表中点选一个选项，下一轮转盘必然停在该选项
- **自动恢复**：指定结果旋转完成后自动清除，恢复权重随机，不留痕迹
- **无痕作弊**：指定结果期间主转盘页无任何提示，与随机模式视觉完全一致
...
3. 进入后台页，点选一个选项作为下一次结果
4. 返回转盘页点击旋转，转盘将停在该选项
5. 旋转完成后指定自动清除，恢复随机模式
6. 可在后台页底部修改后台密码
